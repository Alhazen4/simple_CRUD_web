<?php
    ...
    // else{
        ...
        $query = "INSERT INTO doctor (firsname, lastname, password, email, phonenumber, specialist, harga) VALUES('$fname', '$lname', '$pass', '$email', '$pnumber', '', '');";
        ...
        if ($valid > 0) {
            ...
            echo "<script>
                    ...
                    window.location.href='signindoc.php';
                </script>";
                sleep(3);
                if ($a) {        
            ...
            echo "<script>
                    ...
                    window.location.href='signupdoc.html';
                </script>";
            header('Location: ../signup.html');
        }
    // }
